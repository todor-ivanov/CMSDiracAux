...
# with command line options: QCDForPF_14TeV_TuneCP5_cfi --beamspot DBrealistic --conditions 151X_mcRun3_2025_realistic_v4 --datatier GEN-SIM --era Run3_2025 --eventcontent FEVTDEBUG --fileout file:step1.root --geometry DB:Extended --nStreams 1 --nThreads 8 --no_exec --number 10 --python_filename step_1_cfg.py --relval 500000,100 --step GEN,SIM
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('QCDForPF_14TeV_TuneCP5_cfi nevts:10'),
